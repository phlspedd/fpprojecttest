...
import br.com.fpprojecttest.core.login.LoginContract;
import br.com.fpprojecttest.core.login.LoginPresenter;
import br.com.fpprojecttest.R;
import br.com.fpprojecttest.ui.activities.RegisterActivity;
...
public class LoginFragment extends Fragment implements View.OnClickListener, LoginContract.View{
    ...
    private void setDummyCredentials() {
        mETxtEmail.setText("felipealex@teste.com");
    ...
    public void onLoginSuccess(String message) {
        ...
        Toast.makeText(getActivity(), R.string.logged_in_successfully, Toast.LENGTH_SHORT).show();
